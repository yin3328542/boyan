        ...
        <!--商品表单-->
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="cmd-list">
                        <div class="btn-group">
                            <a id="coupon-main-tab" href="/admin/service" class="btn btn-default">服务项目列表</a>
                            <a id="coupon-add-tab" href="/admin/service/add" class="btn btn-default active"><span class="glyphicon glyphicon-plus"></span>服务项目添加</a>
                        </div>
                    </div>
                </div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <textarea name="description" id="description" class="form-control" cols="60" rows="3" ></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">排序</label>
                            <div class="col-sm-1">
                                <input type="text" class="form-control" name="listorder" id="listorder" maxlength="3" value="255">
                            </div>
                        </div>
                    </form>
                </div>
