        ...
        <div class="panel-body">
            <form class="form-horizontal" role="form" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <textarea name="description" id="description" class="form-control" cols="60" rows="3" ><%=description%></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label">排序</label>
                    <div class="col-sm-1">
                        <input type="text" class="form-control" name="listorder" id="listorder" maxlength="3" value="<%=listorder%>">
                    </div>
                </div>
            </form>
        </div>
