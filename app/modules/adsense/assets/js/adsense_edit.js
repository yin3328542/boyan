...
define([
    ...
    var main_view = function() {
        model.extend({
            url: window._global.url.api+'admin/adsense/'+id,
            options: {}
        }).fetch();
        ...
        $('#J_ImgList').on('click', '.J_Delete', function(e){
            ...
            dialog({
                ...
                ok: function() {
                    $.ajax({
                        async:false,
                        url: window._global.url.api + 'admin/adsense/img/'+img_id,
                        type: 'DELETE',
    ...
    var save_banner = function() {
        ...
        if(!model.extend({
            url : window._global.url.api + 'admin/adsense',
            valid_config : {
                'img_input' : 'required',
            },
            success: function() {
                location.href = '/admin/adsense';
            }
        }).save()) {
            return false;
        }
