        ...
        <!--商品表单-->
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="cmd-list">
                        <div class="btn-group">
                            <a id="coupon-main-tab" href="/admin/banner/<?php echo $_global['type'];?>" class="btn btn-default">轮播图列表</a>
                            <a id="coupon-add-tab" href="/admin/banner/add" class="btn btn-default active"><span class="glyphicon glyphicon-plus"></span>添加</a>
                        </div>
                    </div>
                </div>
