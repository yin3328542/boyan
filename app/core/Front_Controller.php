...
class Front_Controller extends KR_Controller
{
     ...
     * 导航控制器公用函数
     **/
    public function column_str($cm_id)
    {
        if (!$cm_id){$cm_id = 1;}
        $p_column = $this->rest->get('column',array('id'=>$cm_id));
