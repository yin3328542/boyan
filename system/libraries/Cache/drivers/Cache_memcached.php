...
class CI_Cache_memcached extends CI_Driver {
    ...
    protected function _setup_memcached()
    {
        ...
        foreach ($this->_memcache_conf as $name => $cache_server)
        {
            ...
            {
                if(array_key_exists('username', $cache_server) && array_key_exists('password', $cache_server)) {
                ...
                if(array_key_exists('username', $cache_server) && array_key_exists('password', $cache_server)) {
                    $this->_memcached->setSaslAuthData($cache_server['username'], $cache_server['password']);
                }
